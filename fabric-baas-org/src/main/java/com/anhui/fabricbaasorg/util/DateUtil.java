...
public class DateUtil {
    ...
    private final static SimpleDateFormat SDF_DATE_TIME_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    public static String getTime() {
        return SDF_DATE_TIME_FORMAT.format(new Date());
    }
    ...
    public static String getAddDayTime(int i){
        ...
        return SDF_DATE_TIME_FORMAT.format(date);
    }
